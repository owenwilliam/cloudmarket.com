...
import com.owen.cloudmarket.core.dtos.StockProductOverviewDTO;
import com.owen.cloudmarket.core.entities.StockProduct;
import com.owen.cloudmarket.core.enums.MarketCode;
import com.owen.cloudmarket.core.services.IProductService;
...
@RestController
@RequestMapping(value = ProductController.PRODUCT_PATH + "/stocks", produces = {
...
public class StockProductController extends ProductController
{
	...
	public Page<StockProductOverviewDTO> search(
			@And(value = { @Spec(params = "mkt", path = "market.code", spec = EqualEnum.class) }, and = { @Or({
					@Spec(params = "cn", path = "code", spec = LikeIgnoreCase.class),
					@Spec(params = "cn", path = "name", spec = LikeIgnoreCase.class) }) }) @ApiIgnore Specification<StockProduct> spec,
