...
import static com.owen.cloudmarket.core.enums.Role.*;
...
import com.owen.cloudmarket.core.util.UserDetailsUtil;

/**
 * 固定API的请求过程，继承WebContenteraceptor
 * 
...
private static final DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
    ...
    @Value("${realm.name}")
    private String realName = "owenwilliam.com";
