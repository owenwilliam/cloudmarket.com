...
/**
 * IndexController，有普通的请求和Swagger的请求
 * 
...
@RestController
@RequestMapping(value = "/indices", produces = { "application/xml",
		"application/json" })
public class IndexController extends CloudstreetApiWCI
{
	...
	{
		return marketService.getHistoIndex(indexCode, market, fromDate, toDate,
				interval);
	}
}