...
public class HistoProductDTO
{
	...
	public HistoProductDTO(String productName, String code,
			Map<String, BigDecimal> mapValues, Date fromDate, Date toDate)
	{
		this.productName = productName;
		this.code = code;
		this.mapValues = mapValues;

		this.values = mapValues.entrySet().stream().map(entry -> {
