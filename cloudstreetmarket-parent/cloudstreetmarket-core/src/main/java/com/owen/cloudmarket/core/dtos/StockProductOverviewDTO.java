...
public class StockProductOverviewDTO extends ProductOverviewDTO
{
	...
	{
		return new StockProductOverviewDTO(stock.getName(), stock.getCode(),
				(stock.getMarket() != null) ? stock.getMarket().getName()
						: null, stock.getCurrency(),
				stock.getDailyLatestValue(), stock.getDailyLatestChange(),
				stock.getDailyLatestChangePercent(), stock.getPreviousClose(),
